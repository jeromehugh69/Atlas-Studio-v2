...
DEFAULT_AGENTS = [
    ...
    Agent(id=UUID("10000000-0000-0000-0000-000000000015"), name="Echo", role="Voice and Experience Coordinator", description="Coordinates local speech, voice-session behavior, and approved avatar experiences for Atlas Studio.", tools=["speech", "avatar", "memory_read", "files_read"], read_only=True, system=True, skills=["development_lifecycle", "echo_voice"]),
]
