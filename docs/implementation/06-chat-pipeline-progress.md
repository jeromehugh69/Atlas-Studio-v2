...
- **Change 010** — OpenCode governance mirror: sessions auto-file governed intake approvals, permission/tool/idle events audited; console deep-links into workspace (`?directory=`); stale OFFLINE banner re-probe fix
